...
restroom_info:
floormap_url: https://www.esca-sc.com/esca_allshopmap.pdf
...
- 廁所文字位置待補：官網僅提及廁所已導入節水馬桶、自動水栓等設備更新，未提供具體位置文字說明；已補上官方全店舖地圖PDF連結（`floormap_url`），可自行查看地圖上的廁所標示。
...
>
> [[繃皮蛇]]：（原始素材為YouTube影片章節時間軸列表，3:11標註「ESCA地下街」。）
