---
title: 交通儲值卡比較（Manaca／Suica／Icoca）
type: transport
region: transit
station:
district:
...
day_assigned:
transport_mode: IC交通儲值卡
route_from:
route_to:
duration:
cost: 加值：改札外（車站外／一般店家）最低1000円；改札內（車站內）最低100円即可
tags:
  - type/transport
  - region/transit
  - status/researching
...
---
## 簡介
名古屋地區可通用的交通儲值卡比較：manaca（名鐵/地下鐵發行，名古屋站售票機即可購買）、Suica（JR東日本系統，全國車站/店家通用度最高）、Icoca（JR西日本系統）。三種卡在名古屋地區的地鐵、公車、多數店家都可通用。

## 使用重點
1. Suica 的優勢是幾乎什麼車、什麼店都能用，若不確定該辦哪張，優先選 Suica。
